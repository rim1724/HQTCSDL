...
?>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	$product_detail = $conn->prepare("SELECT * FROM `products` WHERE id='$id'");
	$product_detail->execute();
       /* // Kết nối đến database
        ...
        if ($result->num_rows > 0) {
            ...
            // Thêm các thông tin khác tùy theo cấu trúc của bảng sản phẩm
        } else {
...
<?php
	...
	while($row_detail = $product_detail->fetch(PDO::FETCH_ASSOC)){
?>
	<form action="" method="POST">
	<input type="hidden" name="pid" value="<?= $row_detail['id']; ?>">
	<input type="hidden" name="name" value="<?= $row_detail['name']; ?>">
	<input type="hidden" name="price" value="<?= $row_detail['price']; ?>">
	<input type="hidden" name="image" value="<?= $row_detail['image_01']; ?>">
				...
				<div class="row row-pb-lg product-detail-wrap">
						...
						<!--<div class="owl-carousel">-->
							<div class="item">
								<div class="product-entry border">
										...
										<img src="uploaded_img/<?php echo $row_detail['image_01'] ?>" class="img-fluid" alt="Free php5 bootstrap 4 template">
					...
					<div class="col-sm-4">
						<div class="product-desc">
							<h3><?php echo $row_detail['name'] ?></h3>
							<p class="price">
								<span><?php echo number_format($row_detail['price']).'$'?></span> 
								<span class="rate">
							...
							<p><?php echo $row_detail['details'] ?></p>
							<div class="size-wrap">
                    ...
                    <!-- <div class="input-group mb-4">
                  	...
                  	<div class="row">
						  ...
						  <input type="submit" name="buy"  onclick="return confirm('Buy this product?');" value="Buy" class="btn btn-primary btn-addtocart"  class="addtocart" ></input>
