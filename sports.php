...
<?php
    ...
    $select_products = $conn->prepare("SELECT * FROM `products` WHERE category='sport' LIMIT $begin,3 ");
?>
	<head>
	...
	<div id="page">
		...
		<div class="breadcrumbs-two">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="breadcrumbs-img" style="background-image: url(images/item-11.jpg);"">
							<h2>Sports</h2>
						</div>
		...
		<div class="colorlib-product">
			<div class="container">
				...
				<?php
							$sql_page= $conn->prepare("SELECT * FROM `products`WHERE category='sport'");
							$sql_page->execute();
				...
				<div class="row">
							<div class="col-md-12 text-center">
									<ul class="list_trang">
										<?php if($pages-1 > 0){ ?>
										<li ><a href="men.php?page=<?php echo $pages-1 ?>"><i class="ion-ios-arrow-back"></i></a></li>
										<?php } ?>
										<?php
										for($i=1;$i<=$page;$i++){
										?>
										<li <?php if($i == $pages){echo 'style="background:gray;border-radius: 50%"';}else{echo'';} ?>><a href="men.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
										<?php
										}
										?>
										<?php if($pages+1 <= $page){ ?>
										<li ><a href="men.php?page=<?php echo $pages+1 ?>"><i class="ion-ios-arrow-forward"></i></a></li>
										<?php } ?>
									</ul>
